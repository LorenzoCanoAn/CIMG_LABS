...
for i = 1:3
f0_hat(:,:,i) = deconvx(image(:,:,i),aperture,sigma,blurSize(1));
end
...
function f0_hat = deblurring (image, aperture, sigma, blurSize)
...
function f0_hat = deconvx (image, aperture, sigma, blurSize)
